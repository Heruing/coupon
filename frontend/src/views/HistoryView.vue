<template>
    <div class="content-outer">
        <div class="content-wrapper">
            ...
            <input v-model="inputUsername" id="inputUsername" type="text" placeholder="이름을 입력하세요." @keypdress.enter="requestCouponHistory">
            ...
            <div class="button-wrapper">
                <button @click="requestCouponHistory" style="margin-top: 95px;">확인하기</button>
            </div>
        </div>
    </div>
            ...
            <div class="modal" id="modal-history">
                <span v-if="isModalTable" v-show="isModalTable">
                    ...
                    <div class="coupon-tab coupon-content" id="coupon-content" v-for="(item, index) in getMessage">
                        ...
                        <span class="coupon-column coupon-type">{{ item.coupon_type }}</span>
